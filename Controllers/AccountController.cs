...
using StudentApartments.Models.AccountViewModels;
using StudentApartments.Services;
...
namespace StudentApartments.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Set the user role (used in many views)
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return RedirectToAction(nameof(ApartmentController.Index), "Apartment");
        }
